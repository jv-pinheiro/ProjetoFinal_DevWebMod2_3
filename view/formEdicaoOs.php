...
<body>
    ...
    <div>
        <div class="container"  style="margin-top: 8rem;" align="center">
            <div class="row" style="width: 30rem;">
                <div class="card">
                    <div class="card-body" align="left">
                        <form action="../control/controle.php?acao=editar" method="POST">
                            <div class="form-group mb-3">
                                <label>Nome do Solicitante: </label>
                                <input type="text" name="nSolicitante" value="<?php echo $os->getNSolicitante();?>"/>
                            </div>
                            <div class="form-group mb-3">
                                <label>Contato: </label>
                                <input type="text" name="contatoSoli" value="<?php echo $os->getContatoSoli();?>"/>
                            </div>
                            <div class="form-group mb-3">
                                <label>Sobre a ordem de serviço: </label>
                                <input type="text" name="sobre" value="<?php echo $os->getSobre();?>"/>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nExecutor" value="<?php echo $os->getNExecutor();?>"/>
                            </div>
                            <div align="center">
                                <input type="hidden" name="id" value="<?php echo $os->getId();?>"/>
                                <input class="btn btn-info" type="submit" value="Editar">
                                <input class="btn btn-warning" type="reset" name="limpar" value="Recuperar dados anteriores">
                            </div>
                        </form>
                    </div>
                </div>
