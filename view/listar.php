...
<head>
    ...
    <script>
        $(function(){
            $("#os input").keyup(function(){       
                var index = $(this).parent().index();
                var nth = "#os td:nth-child("+(index+1).toString()+")";
...
<div class="tudo">
    ...
    <div class="table-responsive">
        <table id="os" class="table table-responsive table-striped table-hover">
            <thead>
                <tr>
                    <th scope="col">Solicitante</th>
                    <th scope="col">Sobre</th>
                    <th scope="col">Executor</th>
                    <th scope="col">Trouxe Equipamento?</th>
                    <th scope="col">Contato do Solicitante</th>
                    <th scope="col">Ações</th>
                </tr>
                <tr>
                    <th><input style="width: 120px;" type="text" id="txtColuna1"/></th>
                    <th><input style="width: 120px;" type="text" id="txtColuna2"/></th>
                    <th><input style="width: 120px;" type="text" id="txtColuna3"/></th>
                    <th><input style="width: 120px;" type="text" id="txtColuna4"/></th>
                    <th><input style="width: 120px;" type="text" id="txtColuna5"/></th>
                    <th></th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $os->getNSolicitante();?></td>
                    <td><?php echo $os->getSobre();?></td>
                    <td><?php echo $os->getNExecutor();?></td>
                    <td><?php echo $os->getTrouxeEquip();?></td>
                    <td><?php echo $os->getContatoSoli();?></td>
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                            <a class="btn btn-danger" href="../Control/controle.php?acao=excluir&id=<?php echo $os->getId();?>">Excluir</a>
                            <a class="btn btn-warning" href="../Control/controle.php?acao=recuperar&id=<?php echo $os->getId();?>">Editar</a>
                        </div>
                    </td>
                </tr>
                <?php } ?>
